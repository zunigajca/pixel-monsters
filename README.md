...
*   **The Titan Milestones:** Every 10 waves, your squad faces off against heavy-hitting, custom-rendered epic bosses:
...
*   **Active Squad Pool:** Draft, recruit, and level up from a dynamic pool of 9 unique tactical monsters, including front-line specialists like the **Stone-Gargoyle**, stealth infiltrators like the **Crypt-Wraith**, and lethal assets like **Shadow-Fang** and the venomous **Plague-Rat**.
...
*   **Styling:** Pure CSS / Inline Matrix Injection
